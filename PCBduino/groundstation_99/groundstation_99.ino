...
const int nRFCSN = 10;
const int IRQ = 2;
byte msg[] = "htis is a long packet of ninety-nine characters that we are checking for accuracy! 123 orange mango";
boolean sentBool = LOW;
void setup() {
  pinMode(nRF, OUTPUT);
